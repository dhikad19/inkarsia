...
const EditorSlashMenu = ({ items, editor, range }: EditorSlashMenuProps) => (
  ...
  >
    <CommandEmpty className="flex w-full items-center justify-center p-4 text-neutral-500 text-sm dark:text-neutral-400">
      <p>No results</p>
    </CommandEmpty>
    <CommandList>
      {items.map((item) => (
        ...
        >
          <div className="flex size-9 shrink-0 items-center justify-center rounded border border-neutral-200 bg-neutral-100 dark:border-neutral-800 dark:bg-neutral-800">
            <item.icon
  ...
  const defaultExtensions = [
    StarterKit.configure({
      ...
      code: {
        HTMLAttributes: {
          class: cn(
            "rounded-md bg-neutral-100 px-1.5 py-1 font-medium font-mono dark:bg-neutral-800"
          ),
          spellcheck: "false",
        },
      },
      horizontalRule: {
        HTMLAttributes: {
          class: cn(
            "mt-4 mb-6 border-neutral-500 border-t dark:border-neutral-400"
          ),
        },
      },
      dropcursor: {
    ...
    Placeholder.configure({
      placeholder,
      emptyEditorClass:
        "before:text-neutral-500 before:content-[attr(data-placeholder)] before:float-left before:h-0 before:pointer-events-none dark:before:text-neutral-400",
    }),
    ...
    CodeBlockLowlight.configure({
      ...
      HTMLAttributes: {
        class: cn(
          "rounded-md border border-neutral-200 p-4 text-sm dark:border-neutral-800",
    ...
    TableRow.configure({
      HTMLAttributes: {
        class: cn(
          "relative box-border min-w-[1em] border border-neutral-200 p-1 text-start align-top dark:border-neutral-800"
        ),
      },
    }),
    TableCell.configure({
    ...
    TableHeader.configure({
      HTMLAttributes: {
        class: cn(
          "relative box-border min-w-[1em] border border-neutral-200 bg-neutral-100 p-1 text-start align-top font-medium font-semibold text-neutral-500 dark:border-neutral-800 dark:bg-neutral-800 dark:text-neutral-400"
        ),
      },
    }),
    TaskList.configure({
...
export const EditorFloatingMenu = ({
  ...
  <FloatingMenu
    className={cn(
      "flex items-center bg-neutral-100 dark:bg-neutral-800",
      className
    )}
    editor={null}
    tippyOptions={{
...
export const EditorBubbleMenu = ({
  ...
  <BubbleMenu
    className={cn(
      "flex rounded-xl border border-neutral-200 bg-white p-0.5 shadow dark:border-neutral-800 dark:bg-neutral-950",
...
export type EditorNodeImageProps = {
  hideName?: boolean;
};

export const EditorNodeImage = ({ hideName = false }: EditorNodeImageProps) => {
  const { editor } = useCurrentEditor();
  ...
  return (
    <>
      ...
      <BubbleMenuButton
        ...
        icon={ImageIcon}
        name="Upload Image"
        isActive={() => false} // tidak perlu aktif state
      />
    </>
  );
};
    ...
    <Popover modal onOpenChange={onOpenChange} open={open}>
      ...
      <PopoverContent align="start" className="w-60 p-0" sideOffset={10}>
        <form className="flex p-1" onSubmit={handleSubmit}>
          <input
            aria-label="Link URL"
            className="flex-1 bg-white p-1 text-sm outline-none dark:bg-neutral-950"
          ...
          {editor.getAttributes("link").href ? (
            <Button
              className="flex h-8 items-center rounded-sm p-1 text-red-500 transition-all hover:bg-neutral-50 dark:hover:bg-red-500 dark:text-red-900 dark:hover:bg-neutral-50 dark:dark:hover:bg-red-900"
              onClick={() => {
...
export const EditorTableGlobalMenu = ({
  ...
  return (
    <div
      className={cn(
        "-translate-x-1/2 absolute flex translate-y-1/2 items-center rounded-full border border-neutral-200 bg-white shadow-xl dark:border-neutral-800 dark:bg-neutral-950",
        {
          hidden: !(left || top),
        }
      )}
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        asChild
        className={cn(
          "-translate-x-1/2 -translate-y-1/2 absolute flex h-4 w-7 overflow-hidden rounded-md border border-neutral-200 bg-white shadow-xl dark:border-neutral-800 dark:bg-neutral-950",
          {
            hidden: !(left || top),
          }
        )}
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          className={cn(
            "-translate-x-1/2 -translate-y-1/2 absolute flex h-7 w-4 overflow-hidden rounded-md border border-neutral-200 bg-white shadow-xl dark:border-neutral-800 dark:bg-neutral-950",
            {
              hidden: !(left || top),
            }
          )}
...
export const EditorTableColumnDelete = () => {
  ...
  return (
    <DropdownMenuItem className="flex items-center gap-2" onClick={handleClick}>
      <TrashIcon className="text-red-500 dark:text-red-900" size={16} />
...
export const EditorCharacterCount = {
  Characters({ children, className }: EditorCharacterCountProps) {
    ...
    return (
      <div
        className={cn(
          "absolute right-4 bottom-4 rounded-md border border-neutral-200 bg-white p-2 text-neutral-500 text-sm shadow dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-400",
          className
        )}
      >
        {children}
